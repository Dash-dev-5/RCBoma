...
const logDivs = document.querySelector('.logDiv');
...
dev.addEventListener('click',inscription)
...
function inscription(e){
    ...
    inscript.style.width="100%"
    inscript.style.borderRadius="0"
    // logDivs.style.paddingTop="60%"
    // logDivs.style. paddingtop= "0";
...
function confirmation(e){
   ...
   fontBlanc.style.backgroundColor="black";
   fontBlanc.style.Color="white";
...
inscript.addEventListener("click",confirmationss)

function confirmationss (e){
    // e.preventDefault;
    // e.stopPropagation();
